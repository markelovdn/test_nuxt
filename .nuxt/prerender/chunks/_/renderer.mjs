...
import { eventHandler, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getQuery, createError, appendResponseHeader, getResponseStatusText } from 'file:///var/www/test_nuxt/node_modules/h3/dist/index.mjs';
import { stringify, uneval } from 'file:///var/www/test_nuxt/node_modules/devalue/index.js';
import { joinRelativeURL, joinURL, withoutTrailingSlash } from 'file:///var/www/test_nuxt/node_modules/ufo/dist/index.mjs';
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.x; }).then((r) => r.default || r);
